document.addEventListener('DOMContentLoaded', function() {
    ...
    function initWordGuessGame() {
        ...
        function checkAnswer(selectedWord, correctWord) {
            ...
            optionButtons.forEach(btn => {
                ...
                } else if (btn.textContent === selectedWord && selectedWord !== correctWord) {
            ...
            if (gameFeedback) {
                if (isCorrect) {
                    gameFeedback.innerHTML = '<div class="correct-feedback">Bener! 🎉</div>';
                    score += 10;
                } else {
    ...
    function initSentenceBuilderGame() {
        ...
        function removeWord(index) {
            ...
            if (index >= 0 && index < selectedWords.length) {
                ...
                wordButtons.forEach(btn => {
                    if (btn.dataset.word === removedWord && btn.classList.contains('selected')) {
        ...
        function checkSentence() {
            ...
            if (gameFeedback) {
                if (isCorrect) {
                    gameFeedback.innerHTML = '<div class="correct-feedback">Bener! Kalimah téh bener! 🎉</div>';
                    score += 15;
                } else {
    ...
    function initCultureQuizGame() {
        ...
        const quizQuestions = [
            {
                question: "Alat musik tradisional Sunda yang terbuat dari bambu dan dimainkan dengan cara dipukul adalah...",
                image: "img/quiz/angklung.jpg",
                options: ["Angklung", "Calung", "Kecapi", "Suling"],
                answer: "Angklung"
            },
            {
                question: "Tarian tradisional Sunda yang diciptakan oleh Gugum Gumbira adalah...",
                image: "img/quiz/jaipongan.jpg",
                options: ["Merak", "Jaipong", "Topeng", "Ketuk Tilu"],
                answer: "Jaipong"
            },
            {
                question: "Cerita rakyat Sunda tentang asal-usul Gunung Tangkuban Parahu melibatkan tokoh...",
                image: "img/quiz/sangkuriang.jpg",
                options: ["Lutung Kasarung", "Sangkuriang", "Si Kabayan", "Mundinglaya"],
                answer: "Sangkuriang"
            },
            {
            ...
            {
                question: "Makanan khas Sunda yang terbuat dari oncom yang difermentasi adalah...",
        ...
        function checkQuizAnswer(selectedOption, correctOption) {
            ...
            optionButtons.forEach(btn => {
                ...
                if (btn.textContent === correctOption) {
                    btn.classList.add('correct-option');
                } else if (btn.textContent === selectedOption && selectedOption !== correctOption) {
                    btn.classList.add('wrong-option');
                }
            });
            ...
            if (gameContainer) {
                gameContainer.innerHTML = `
                    <div class="quiz-results">
                        ...
                        <p>Anjeun meunang skor ${score} tina ${quizQuestions.length * 20} poin.</p>
