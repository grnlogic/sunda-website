...
function animateSectionsOnScroll() {
    ...
    const elements = document.querySelectorAll('.section-header, .category-card, .exercise-card, .game-card, .stat-card, .aksara-interactive, .aksara-learn');
...
function animateCategoryCards() {
    const cards = document.querySelectorAll('.category-card, .exercise-card, .game-card');
